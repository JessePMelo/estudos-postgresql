...
\restrict Rj9WiHS6JFsWYBLV4a9faK2ZdGRPaditrUKiZQ87hKooXnvzhMDzBzoSSbWsc3a
...
--
-- Name: avaliacoes; Type: TABLE; Schema: public; Owner: jesse
--
...
ALTER TABLE public.avaliacoes OWNER TO jesse;

--
-- Name: avaliacoes_id_seq; Type: SEQUENCE; Schema: public; Owner: jesse
--
...
ALTER SEQUENCE public.avaliacoes_id_seq OWNER TO jesse;

--
-- Name: avaliacoes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jesse
--
...
--
-- Name: corridas; Type: TABLE; Schema: public; Owner: jesse
--
...
ALTER TABLE public.corridas OWNER TO jesse;

--
-- Name: corridas_id_seq; Type: SEQUENCE; Schema: public; Owner: jesse
--
...
ALTER SEQUENCE public.corridas_id_seq OWNER TO jesse;

--
-- Name: corridas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jesse
--
...
--
-- Name: localizacoes; Type: TABLE; Schema: public; Owner: jesse
--
...
ALTER TABLE public.localizacoes OWNER TO jesse;

--
-- Name: localizacoes_id_seq; Type: SEQUENCE; Schema: public; Owner: jesse
--
...
ALTER SEQUENCE public.localizacoes_id_seq OWNER TO jesse;

--
-- Name: localizacoes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jesse
--
...
--
-- Name: motoristas; Type: TABLE; Schema: public; Owner: jesse
--
...
ALTER TABLE public.motoristas OWNER TO jesse;

--
-- Name: motoristas_id_seq; Type: SEQUENCE; Schema: public; Owner: jesse
--
...
ALTER SEQUENCE public.motoristas_id_seq OWNER TO jesse;

--
-- Name: motoristas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jesse
--
...
--
-- Name: pagamentos; Type: TABLE; Schema: public; Owner: jesse
--
...
ALTER TABLE public.pagamentos OWNER TO jesse;

--
-- Name: pagamentos_id_seq; Type: SEQUENCE; Schema: public; Owner: jesse
--
...
ALTER SEQUENCE public.pagamentos_id_seq OWNER TO jesse;

--
-- Name: pagamentos_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jesse
--
...
--
-- Name: usuarios; Type: TABLE; Schema: public; Owner: jesse
--
...
ALTER TABLE public.usuarios OWNER TO jesse;

--
-- Name: usuarios_id_seq; Type: SEQUENCE; Schema: public; Owner: jesse
--
...
ALTER SEQUENCE public.usuarios_id_seq OWNER TO jesse;

--
-- Name: usuarios_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jesse
--
...
--
-- Name: avaliacoes id; Type: DEFAULT; Schema: public; Owner: jesse
--
...
--
-- Name: corridas id; Type: DEFAULT; Schema: public; Owner: jesse
--
...
--
-- Name: localizacoes id; Type: DEFAULT; Schema: public; Owner: jesse
--
...
--
-- Name: motoristas id; Type: DEFAULT; Schema: public; Owner: jesse
--
...
--
-- Name: pagamentos id; Type: DEFAULT; Schema: public; Owner: jesse
--
...
--
-- Name: usuarios id; Type: DEFAULT; Schema: public; Owner: jesse
--
...
--
-- Data for Name: avaliacoes; Type: TABLE DATA; Schema: public; Owner: jesse
--
...
--
-- Name: avaliacoes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jesse
--
...
--
-- Name: corridas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jesse
--

SELECT pg_catalog.setval('public.corridas_id_seq', 52, true);


--
-- Name: localizacoes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jesse
--

SELECT pg_catalog.setval('public.localizacoes_id_seq', 2, true);


--
-- Name: motoristas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jesse
--

SELECT pg_catalog.setval('public.motoristas_id_seq', 7, true);


--
-- Name: pagamentos_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jesse
--

SELECT pg_catalog.setval('public.pagamentos_id_seq', 54, true);


--
-- Name: usuarios_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jesse
--
...
--
-- Name: avaliacoes avaliacoes_pkey; Type: CONSTRAINT; Schema: public; Owner: jesse
--
...
--
-- Name: corridas corridas_pkey; Type: CONSTRAINT; Schema: public; Owner: jesse
--
...
--
-- Name: localizacoes localizacoes_pkey; Type: CONSTRAINT; Schema: public; Owner: jesse
--
...
--
-- Name: motoristas motoristas_pkey; Type: CONSTRAINT; Schema: public; Owner: jesse
--
...
--
-- Name: pagamentos pagamentos_pkey; Type: CONSTRAINT; Schema: public; Owner: jesse
--
...
--
-- Name: usuarios usuarios_pkey; Type: CONSTRAINT; Schema: public; Owner: jesse
--
...
--
-- Name: avaliacoes avaliacoes_corrida_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jesse
--

ALTER TABLE ONLY public.avaliacoes
    ADD CONSTRAINT avaliacoes_corrida_id_fkey FOREIGN KEY (corrida_id) REFERENCES public.corridas(id);


--
-- Name: corridas corridas_motorista_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jesse
--

ALTER TABLE ONLY public.corridas
    ADD CONSTRAINT corridas_motorista_id_fkey FOREIGN KEY (motorista_id) REFERENCES public.motoristas(id);


--
-- Name: corridas corridas_passageiro_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jesse
--

ALTER TABLE ONLY public.corridas
    ADD CONSTRAINT corridas_passageiro_id_fkey FOREIGN KEY (passageiro_id) REFERENCES public.usuarios(id);


--
-- Name: localizacoes localizacoes_corrida_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jesse
--

ALTER TABLE ONLY public.localizacoes
    ADD CONSTRAINT localizacoes_corrida_id_fkey FOREIGN KEY (corrida_id) REFERENCES public.corridas(id);


--
-- Name: motoristas motoristas_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jesse
--

ALTER TABLE ONLY public.motoristas
    ADD CONSTRAINT motoristas_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id);


--
-- Name: pagamentos pagamentos_corrida_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jesse
--

ALTER TABLE ONLY public.pagamentos
    ADD CONSTRAINT pagamentos_corrida_id_fkey FOREIGN KEY (corrida_id) REFERENCES public.corridas(id);
...
\unrestrict Rj9WiHS6JFsWYBLV4a9faK2ZdGRPaditrUKiZQ87hKooXnvzhMDzBzoSSbWsc3a
